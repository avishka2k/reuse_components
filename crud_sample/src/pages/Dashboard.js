    ...
    <>
      <div className="w-full h-full dark:bg-gray-800">
        <div className="flex flex-no-wrap">
          {/* Sidebar starts */}
          <div className="absolute lg:relative w-64 h-screen shadow dark:bg-gray-900 text-white hidden lg:block">
            <div className="h-16 w-full flex items-center px-8">DashBoard</div>
            <ul aria-orientation="vertical" className="py-6">
              <li className="pl-6 cursor-pointer text-sm leading-3 tracking-normal mt-4 mb-4 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
              ...
              <li className="pl-6 cursor-pointer text-sm leading-3 tracking-normal mt-4 mb-4 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                <div className="flex items-center">
                  <IoExtensionPuzzleOutline className="text-lg" />
                  <span className="ml-2">Products</span>
                </div>
              </li>
              <li className="pl-6 cursor-pointer text-sm leading-3 tracking-normal mb-4 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                <div className="flex items-center">
                  <IoCompassOutline className=" text-lg" />
                  <span className="ml-2">Performance</span>
                </div>
              </li>
              <li className="pl-6 cursor-pointer text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                <div className="flex items-center">
          ...
          <div className="w-full">
            {/* Navigation starts */}
            <nav className="h-16 flex items-center lg:items-stretch justify-end lg:justify-between dark:bg-gray-900 shadow relative z-10">
              <div className="hidden lg:flex w-full pr-6">
                <div className="w-1/2 h-full hidden lg:flex items-center pl-6 pr-24">
                  <div className="relative w-full">
                    ...
                    <input
                      className="border border-gray-600 focus:outline-none focus:border-indigo-700 rounded w-full text-sm text-gray-500 dark:bg-gray-800 pl-12 py-2"
                      type="text"
                      placeholder="Search"
                    />
                  </div>
                ...
                <div className="w-1/2 hidden lg:flex">
                  <div className="w-full flex items-center pl-8 justify-end">
                    ...
                    >
                      ...
                      <p className="text-sm min-w-[3rem] mx-3 text-white">{currentUser.email}</p>
